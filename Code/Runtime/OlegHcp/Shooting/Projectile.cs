                    ...
                    switch (hitOption.Reaction)
                    {
                        ...
                        case HitReactionType.MoveThrough:
                        {
                            ...
                            if (duplicated)
                            {
                                ...
                                newSource = Vector3.LerpUnclamped(newSource, destination, (1f / _speed).Clamp(0.01f, 1f));
                            ...
                            else
                            {
                                ...
                                Vector3 newSource = Vector3.LerpUnclamped(hitPos, newDest, (1f / _speed).Clamp(0.01f, 1f));
